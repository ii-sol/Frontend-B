    ...
    <>
      ...
      <div tw="flex flex-col h-screen">
        <main tw="flex flex-col items-center rounded-2xl">
          ...
          <div tw="flex flex-row justify-between w-full px-4 mt-6">
            <button
              tw="bg-red-500 text-white py-2 px-4 rounded-2xl w-1/2 mr-2"
            ...
            <button
              tw="bg-blue-500 text-white py-2 px-4 rounded-2xl w-1/2 ml-2"
